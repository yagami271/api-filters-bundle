...
final class DbalFilterApplier implements DbalFilterApplierInterface
{
    /** @var array<string, DbalFilterStrategyInterface> */
    private readonly array $strategies;

    /**
     * @param iterable<DbalFilterStrategyInterface> $strategies
     */
    public function __construct(
        #[AutowireIterator('isma_api_filters.dbal_strategy')]
        iterable $strategies,
    ) {
        $map = [];
